...
function PauseButton({
  ...
  return (
    <button
      ...
      className="mx-auto flex items-center gap-2 rounded-full border border-white/10 bg-black/40 px-4 py-2 text-[11px] font-medium uppercase tracking-[0.14em] text-neutral-300 transition hover:border-white/20 hover:text-white"
    >
      {isPaused ? (
        <svg
          aria-hidden
